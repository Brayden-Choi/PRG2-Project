...
namespace PRG2_T06_Team9
{
    class TravelEntry
    {
        ...
        {
            return string.Format("Last Country of Embarkation: {0,-25}Entry Mode: {1,-10}Entry Date: {2,-28}End Date: {3,-28}Is Paid: {4,-10}", LastCountryOfEmbarkation, EntryMode, EntryDate, ShnEndDate, IsPaid);
        }
    }
}
